...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_3__.getPaymentMethodData)(_constants__WEBPACK_IMPORTED_MODULE_6__.GATEWAY_ID_GOOGLE_PAY, {});
const defaultLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Google Pay by DNA Payments', _constants__WEBPACK_IMPORTED_MODULE_6__.TEXT_DOMAIN);
...
const GooglePayButton = props => {
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_payment_component__WEBPACK_IMPORTED_MODULE_7__.PaymentComponent, {
    ...
    gatewayId: _constants__WEBPACK_IMPORTED_MODULE_6__.GATEWAY_ID_GOOGLE_PAY,
    containerId: _constants__WEBPACK_IMPORTED_MODULE_6__.CONTAINER_IDS.googlepay,
    errorMessage: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Google Pay payments are not supported in your current browser.', _constants__WEBPACK_IMPORTED_MODULE_6__.TEXT_DOMAIN),
    props: props
  });
};
...
const dnapaymentsGooglePayPaymentMethod = {
  name: _constants__WEBPACK_IMPORTED_MODULE_6__.GATEWAY_ID_GOOGLE_PAY,
  label: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Label, null),
  content: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(GooglePayButton, null),
...
(0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_1__.registerPaymentMethod)(dnapaymentsGooglePayPaymentMethod);
/******/ })()
;
//# sourceMappingURL=dnapayments_googlepay.js.map